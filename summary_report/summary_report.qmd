...
```
This report provides several metrics of interest over the geographic extent of the [AOI_name] AOI, including the distribution of forest age, dominant species, common disturbances, topographic variables, and others. It also summarizes key outputs from the prepR workflow. More details on the data, methodology, and results from the prepR workflow can be found in the PEM Manual.
